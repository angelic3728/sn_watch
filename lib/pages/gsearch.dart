...
class _GSearchPageState extends State<GSearchPage> {
  ...
  _initiateSearch() async {
    if(searchEditingController.text.isNotEmpty){
      ...
      await DatabaseMethods().searchByGName(searchEditingController.text).then((snapshot) {
  ...
  _joinValueInGroup(String userName, String groupId, String groupName, String admin) async {
    bool value = await DatabaseMethods().isUserJoined(Constants.myUID, groupId, groupName, userName);
    setState(() {
      _isJoined = value;
    });
  }
  ...
  Widget groupTile(String userName, String userId, String groupId, String groupName, String admin){
    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: () async {
          await DatabaseMethods().togglingGroupJoin(Constants.myUID, groupId, groupName, userName);
          if(_isJoined) {
            setState(() {
              _isJoined = !_isJoined;
            });
            ...
            Future.delayed(Duration(milliseconds: 2000), () {
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => GChatPage(groupId: groupId, userId: userId, userName: userName, groupName: groupName)));
            });
          }
          else {
            setState(() {
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Search groups with Group Name and Administrator's Name.",
                        hintStyle: TextStyle(
